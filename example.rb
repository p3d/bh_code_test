...
item1 = Item.new(code: '001', name: 'Lavender heart', price: 9.25)
item2 = Item.new(code: '002', name: 'Personalised cufflinks', price: 45.00)
item3 = Item.new(code: '003', name: 'Kids T-shirt', price: 19.95)
